Ext.define('MPortal.view.dashboard.Dashboard', {
    ...
    requires: [
        'MPortal.view.dashboard.DashboardController',
        'MPortal.view.dashboard.DashboardModel',
        'Ext.grid.column.Widget',
        'MPortal.override.grid.column.Date',
